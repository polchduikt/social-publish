...
public interface SlackSettingsRepository extends JpaRepository<SlackSettingsEntity, UUID>, BaseIntegrationSettingsRepository<SlackSettingsEntity> {
    Optional<SlackSettingsEntity> findByUserId(UUID userId);
}
